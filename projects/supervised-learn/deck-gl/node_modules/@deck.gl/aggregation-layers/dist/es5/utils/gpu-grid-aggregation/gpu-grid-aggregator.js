        ...
        if (needMin || needMax) {
          if (needMin && needMax && combineMaxMin) {
            if (!maxMinFramebuffers[id]) {
              resources["".concat(id, "-maxMin")] = (0, _resourceUtils.getFloatTexture)(this.gl, {
            ...
            if (needMin) {
              if (!minFramebuffers[id]) {
                resources["".concat(id, "-min")] = (0, _resourceUtils.getFloatTexture)(this.gl, {
                  id: "".concat(id, "-minTex")
                });
            ...
            if (needMax) {
              if (!maxFramebuffers[id]) {
                resources["".concat(id, "-max")] = (0, _resourceUtils.getFloatTexture)(this.gl, {
                  id: "".concat(id, "-maxTex")
                });
